...
<html>
<head>
<title>Vivah.com | Homepage</title>
...
$(function () {
        $('.floating-wpp').floatingWhatsApp({
            phone: '+919272729564',
            popupMessage: 'Welcome to Vivah.com',
            showPopup: true,
            position: 'right', // left or right
            autoOpen: false, // true or false
            //autoOpenTimer: 4000,
            message: 'Hello !! How are you ? I am Bhargav ',
...
<div class="banner">
  <div class="container">
    <div class="banner_info" align="right">
      <h3 style="color:#F50057;" ><!--<img src="images/ver.png" width="80px">--> Lots of Verified Members </h3>
...
<div class="grid_2">
	         ...
	         <ul> 
			   <li>
				  	<div class="suceess_story-date">
						<span class="entry-1">Dec 20, 2020</span>
					</div>
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Arun & Geeta</a></h4>				        	
				        	<p>There are lots of good options available and provided by them. I really liked it :)<a href="#">More...</a></p>
				        </div>
				    </div>
				</li>
	            <li>
	      ...
	      <h3>News & Events</h3>
	        <div class="box_1">
			  ...
			  <div class="extra-wrap">
				...
				<h4 class="post-title"><a href="#">Sachin Jagtap</a></h4>
				<div class="clearfix"> </div>
				<div class="post-content">Thank you vivah.com for providing such an amazing platform</div>
    ...
    <div class="bg">
		<div class="container"> 
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		<h4>Best for Everyone</h4>
            		<h5>Rahul Shetty</h5>
            		<p>"We have a very Great Experince here Thank you vivah.com"</p>
