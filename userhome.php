...
<html>
<head>
<title>Vivah.com | UserHome</title>
...
<img src="images/verify.svg" class="img-responsive" alt=""/ width="180px" height="160px">
    <div>
     <ul>
        <a href="index.php"><i class="fa fa-home home_1"></i></a>
        <span class="divider">&nbsp;|&nbsp;</span>
        <li class="current-page"><h1>User Home<h1></li>
     </ul>
    </div>
  </div>
<div class="navigation" style="background-color: #6C63FF;" >
   	
   	  	<div class="collapse navbar-collapse" id="bs-megadropdown-tabs" data-target=".navbar collapse">
